package org.sewingdivision.config;
...
public class SecurityConfig {
            ...
            httpSecurity
                    .authorizeHttpRequests(
                            (httpRequestConfigurer) -> httpRequestConfigurer
                                    .requestMatchers("/addArticle").authenticated()
    ...
    public UserDetailsManager users(DataSource dataSource) {
        ...
        jdbcUserDetailsManager.setAuthoritiesByUsernameQuery("SELECT email, role FROM seller WHERE email = ?");
